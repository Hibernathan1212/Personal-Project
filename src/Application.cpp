...
Application::Application(const ApplicationSpecification& specification)
    : m_Specification(specification), g_Camera(45.0f, 0.1f, 100.0f)
{
    Init();
}
...
void Application::Init()
{
    ...
    objects[1].Vertices.push_back(glm::vec3(-2.0f, 0.0f +  2.0f, 5.0f + (-0.5f)));
    objects[1].Vertices.push_back(glm::vec3( 2.0f, 0.0f +  2.0f, 5.0f + (-0.5f)));
    objects[1].Vertices.push_back(glm::vec3( 2.0f, 0.0f +  2.0f, 5.0f + ( 0.5f)));
    objects[1].Vertices.push_back(glm::vec3(-2.0f, 0.0f +  2.0f, 5.0f + ( 0.5f)));
    objects[1].Vertices.push_back(glm::vec3(-2.0f, 0.0f + -2.0f, 5.0f + (-0.5f)));
    ...
    objects[1].Velocity = glm::vec3(0.0f, 0.0f, -0.5f);
    objects[1].angularVelocity = glm::vec3(0.0f, 0.5f, 0.0f);
...
void PhysicsUpdate(bool &Running, Scene &scene)
{
    ...
    while(!glfwWindowShouldClose(g_WindowHandle) && Running)
    {
        ...
        std::this_thread::sleep_until(start + 100000ns);
    }
}
